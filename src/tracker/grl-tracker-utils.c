...
set_int_metadata_keys (TrackerSparqlCursor *cursor,
                       ...
                       GrlKeyID             key)
{
  const gint *str = tracker_sparql_cursor_get_integer (cursor, column);
  grl_data_set_int (GRL_DATA (media), key, str);
}
...
grl_tracker_setup_key_mappings (void)
{
  ...
  insert_key_mapping_with_setter (GRL_METADATA_KEY_ALBUM,
                                  NULL,
                                  "nmm:albumTitle(nmm:musicAlbum(?urn))",
                                  "audio",
                                  set_string_metadata_keys);

  insert_key_mapping_with_setter (GRL_METADATA_KEY_ALBUM_DISC_NUMBER,
                                  NULL,
                                  "nmm:setNumber(nmm:musicAlbumDisc(?urn))",
                                  "audio",
                                  set_int_metadata_keys);

  insert_key_mapping_with_setter (GRL_METADATA_KEY_ARTIST,
                                  NULL,
  ...
  insert_key_mapping_with_setter (GRL_METADATA_KEY_DURATION,
                                  "nfo:duration",
                                  "nfo:duration(?urn)",
                                  "audio",
                                  set_int_metadata_keys);
  ...
  insert_key_mapping_with_setter (GRL_METADATA_KEY_MB_ARTIST_ID,
                                  "nmm:mbArtistID",
                                  "nmm:mbArtistID(?urn)",
                                  "audio",
                                  set_string_metadata_keys);
  ...
  insert_key_mapping_with_setter (GRL_METADATA_KEY_MB_RELEASE_ID,
                                  "nmm:mbReleaseID",
                                  "nmm:mbReleaseID(?urn)",
                                  "audio",
                                  set_string_metadata_keys);

  insert_key_mapping_with_setter (GRL_METADATA_KEY_MB_RELEASE_GROUP_ID,
