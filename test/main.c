...
main (void)
{
  ...
  if (1) ms_media_source_search (youtube, "igalia", keys, NULL, 1, 10, MS_RESOLVE_FULL | MS_RESOLVE_FAST_ONLY, browse_cb, NULL);
  if (0) ms_metadata_source_get (MS_METADATA_SOURCE (youtube), "okVW_YSHSPU", keys, 0, metadata_cb, NULL);
  if (0) ms_metadata_source_get (MS_METADATA_SOURCE (youtube), "categories", keys, MS_RESOLVE_FAST_ONLY | MS_RESOLVE_FULL, metadata_cb, NULL);
